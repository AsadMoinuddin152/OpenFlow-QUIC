...
/* EPM added */
func (s *session) ReturnSessionRttStats() *utils.RTTStats{
	return s.connFlowController.GetRttStats()
}

func (s *session) GetAllStreamQueue(QueuingStream []protocol.StreamID) {
	s.framer.ReturnActiveStream(QueuingStream)
}
